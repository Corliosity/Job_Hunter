...
/**
 The base class for all corn modules
 */
...
/**
 corn Platform calls this method on startup.
 */
-(void)startup;

/**
 corn Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 corn Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 corn Platform calls this method on resume.
 @param sender The sender of the event.
 */
