...
// in simulator we redefine to format for corn Developer console
...
{\
	NSString * exceptionName = [@"org.corn." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.corn";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIcornNativeItemNone = -1, 
	UIcornNativeItemSpinner = -2,
	UIcornNativeItemProgressBar = -3,
	
	UIcornNativeItemSlider = -4,
	UIcornNativeItemSwitch = -5,
	UIcornNativeItemMultiButton = -6,
	UIcornNativeItemSegmented = -7,
	
	UIcornNativeItemTextView = -8,
	UIcornNativeItemTextField = -9,
	UIcornNativeItemSearchBar = -10,
	
	UIcornNativeItemPicker = -11,
	UIcornNativeItemDatePicker = -12,
	
	UIcornNativeItemInfoLight = -13,
	UIcornNativeItemInfoDark = -14,
	
	UIcornNativeItemDisclosure = -15,
	
	UIcornNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all corn instances of
