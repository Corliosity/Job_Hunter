 ...
 * Copyright (c) 2009-2011 by corn, Inc. All Rights Reserved.
...
//@interface cornObject : NSObject
//@end

@interface cornObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[cornObject class]])
		{
			for (NSString *key in [[(cornObject*)o modules] allKeys])
			{
