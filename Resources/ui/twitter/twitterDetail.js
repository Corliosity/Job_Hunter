 ...
 */
function twitterDetail(idTitle, idDetail, parentWindow){
...
function prettyDate(time){
	...
	xhr.timeout = 1000000;
	xhr.open("GET","http://api.twitter.com/1/statuses/user_timeline.json?screen_name="+idDetail);
	...
	xhr.onload = function()
	{
		...
		win.setRightNavButton(compose)
		
		return win;
}

module.exports = twitterDetail;